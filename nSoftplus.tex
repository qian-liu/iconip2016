...
%	}
	...
	\subfloat[Noisy Softplus in 3D]{
		\label{Fig:3d}
		\includegraphics[width=0.5\textwidth]{pic/5.pdf}
	}
	\caption{
...
\begin{figure}[bt!]
	...
	\subfloat[Loss over training.]{
		\label{Fig:loss}
		\includegraphics[width=0.5\textwidth]{pic/8.pdf}
	}
	\subfloat[Classification accuracy varies over time.]{
		\label{Fig:response}
		\includegraphics[width=0.5\textwidth]{pic/9.pdf}
	}
	\caption{
