...
\graphicspath{{./pic/}} % PUT ALL PDF/JPG/PNG FIGURES IN THIS SUBDIRW
\begin{document}
...
%	~\cite{la2008response}
	...
	\begin{figure}[bt!]
		...
		\subfloat[$\tau_{syn}=1$~ms]{
			\label{Fig:lif_pois1}
			\includegraphics[width=0.5\textwidth]{pic/3-1}
		}
		\subfloat[$\tau_{syn}=5$~ms]{
			\label{Fig:lif_pois5}
			\includegraphics[width=0.5\textwidth]{pic/3-2}
		}
		\caption{
	...
	\begin{figure}[htb!]
		...
		\subfloat[Noisy Softplus in 3D]{
			\label{Fig:3d}
			\includegraphics[width=0.45\textwidth]{pic/5}
		}\\
		\subfloat[$k=0.17$ and $\tau_{syn}=1$~ms]{
			\label{Fig:nsptau1}
			\includegraphics[width=0.5\textwidth]{pic/4-1}
		}
		\subfloat[$k=0.3$ and $\tau_{syn}=5$~ms]{
			\label{Fig:scale}
			\includegraphics[width=0.5\textwidth]{pic/4-2}
		}
		\caption{
	...
	\begin{figure}[bt!]
		...
		\subfloat[Pixel firing rates]{
			\label{Fig:62}
			\includegraphics[width=0.3\textwidth]{pic/6-2}
		}
		\subfloat[5x5 kernel]{
			\label{Fig:63}
			\includegraphics[width=0.3\textwidth]{pic/6-3}
		}
		\subfloat[Output firing rates]{
			\label{Fig:64}
			\includegraphics[width=0.3\textwidth]{pic/6-4}
		}
		\\
		...
		\subfloat[Observed `activation functions']{
			\label{Fig:65}
			\includegraphics[width=0.5\textwidth]{pic/6-5}
		}
		\caption{
...
%	~\cite{lecun1998gradient}
	...
	\begin{figure}[bt!]
		...
		\subfloat[Ouput firing rates]{
			\label{Fig:out}
			\includegraphics[width=0.26\textwidth]{pic/7}
		}
		\subfloat[Loss over training]{
			\label{Fig:loss}
			\includegraphics[width=0.35\textwidth]{pic/8}
		}
		\subfloat[Performance over time]{
			\label{Fig:response}
			\includegraphics[width=0.35\textwidth]{pic/9}
		}
		\caption{
